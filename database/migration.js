...
try {
    ...
    con.query("CREATE TABLE `balance_history` (`id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT, `gid` INT(10) UNSIGNED NULL DEFAULT NULL, `date` DATE NULL DEFAULT NULL, `in` INT(11) NULL DEFAULT NULL, `out` INT(11) NULL DEFAULT NULL, PRIMARY KEY (`id`) USING BTREE) COLLATE='utf8mb4_general_ci' ENGINE=InnoDB;")
} catch (e) {
